...
bool (*GameEngineCollision::CollisionFunction[static_cast<int>(CollisionType::Null)][static_cast<int>(CollisionType::Null)])(const CollisionData& _LeftData, const CollisionData& _RightData) = { nullptr };
	...
	, CollisionType _OtherType)
{
	...
	{
		MsgBoxAssert("충돌체크함수가 존재하지 않습니다.");
		return false;
	}
